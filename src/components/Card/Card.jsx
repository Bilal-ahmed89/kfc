        ...
        <div className="row justify-content-between">
            {
                cardContent.map((cardContent) => {
                    return (
                        <div className={`col-md-4 ps-4 mb-3 ${styles.bgCard}`}>
                            <div className="card border-0 m-0" style={{ width: '16rem', backgroundColor: '#1C1816', paddingTop: '30px' }}>
                                ...
                                <div className="card-body py-3 ps-1">
                                    ...
                                    <p className="card-text" style={{ color: '#D4D4D4', height : '60px' }}>{cardContent.description}</p>
                                    <span className={`d-flex justify-content-between align-items-center pt-2`}>
                                        <h4 className='fw-bold m-0'>Rs {cardContent.price} </h4>
                                        <button className={`text-white border-0 px-3 py-1 rounded-3 ${styles.bgRed}`} >Add to Bucket</button>
                                    </span>
                                </div>
                            </div>
                        </div>
